...
void main() {
    ...
    while(count) {  // While count variable becomes 0 looping
        ...
        cout<<(temp/mul)%10; // The logic. temp/mul is always return two digits and after divide it by 10 it will return appropiate decimal weight
